...
void initBoard()
{
    ...
    digitalWrite(OLED_RST, HIGH); delay(200);
    digitalWrite(OLED_RST, LOW);  delay(200);
    digitalWrite(OLED_RST, HIGH); delay(200);
#endif
    ...
    * * * * */
    ...
    if (Wire1.endTransmission() == 0) {
        ...
        u8g2 = new U8G2_SSD1306_128X64_NONAME_F_HW_I2C(U8G2_R0, U8X8_PIN_NONE, I2C_SCL2, I2C_SDA2);
        u8g2->begin();
        u8g2->clearBuffer();
        u8g2->setFlipMode(0);
